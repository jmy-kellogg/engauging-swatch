...
export default function SideMenu() {
  ...
  return (
    <div className="bg-menu text-espresso flex flex-col h-screen w-max">
      <svg
      ...
      >
        ...
        {isOpen && <h3 className="font-bold w-40">Gauge Calculator</h3>}
      </Link>
      <Link
        href="/filet"
        className="flex p-2 items-center gap-2 hover:underline hover:underline-offset-4 hover:bg-sage-200"
      ...
      >
        ...
        {isOpen && <h3 className="font-bold w-50">Filet Pattern Maker</h3>}
      </Link>
      <Link
        href="/stitches"
        className="flex p-2 items-center gap-2 hover:underline hover:underline-offset-4 hover:bg-sage-200"
      ...
      >
        ...
        {isOpen && <h3 className="font-bold">Getting Started</h3>}
      </Link>
    </div>
  );
}
